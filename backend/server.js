...
const STOPWORDS = new Set([
  ...
  "know", "known", "can", "cannot", "could", "couldn't", "old", "age", "time", "cant", "answer", "front", "of", "off", "place", "find"
]);
...
If the question is something like asking about who made u or who is the owner of u something like that or about application then simply answer "Not in textbook.".
Provide a clear and concise answer in 3-4 sentences. Do not write anything else other than the answer.
If the question requires only a 1-word answer, give just give 1 word answer without unnecessary details.
Textbook Content:
${context}
